...
from detector       import detect_pack_type, detect_base_version
...
def run(pack_url: str, staging_dir: str = "staging", output_name: str = "converted_pack.zip"):
    ...
    1. Download & extract
    2. Detect type + version
    3. Build overlay structure
    4. Convert item models (if needed for 1.21.2+)
    5. Handle ModelEngine assets
    6. Generate pack.mcmeta
    7. Package output
    """
